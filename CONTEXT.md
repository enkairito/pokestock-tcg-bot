...
- **Amazon UK y USA tienen restricciones especiales**, pedidas
  ...
  - Amazon USA usa una página de tienda con parámetro `search?terms=tcg`
    (URL directa proporcionada por el usuario), no el formato
    `stores/page/<ID>` simple de ES/UK.
